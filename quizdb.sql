...
--
-- Gazdă: 127.0.0.1
-- Timp de generare: dec. 20, 2023 la 02:09 PM
...
INSERT INTO `users` (`id`, `email`, `parola`, `nume`, `username`, `score`, `status`) VALUES
(3, 'andreea.vechiu@gmail.com', '$2y$10$gdSoWNLtqbM675bPH5s.Q.of/BXJHzA4roSq9D/IwbWNSCAH7PcA2', 'Vechiu Andreea', 'Andreea26', 6, 'user'),
(5, 'dany@gmail.com', '$2y$10$N2coElQ/6CZQGH8Plnbwqu/JxsQM.KHGcM4WnWU47f1mH9MbiqdPK', 'daniel', 'danielgstefan', 10, 'admin'),
(6, 'geta@gmail.com', '$2y$10$cfYlsUChfXYcxNoGZAbVd.Wx62iQtGEWnSGUkL.z0Ak2SaG5hqN4C', 'Geta', 'Geta20', 9, 'user');
